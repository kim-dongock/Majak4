...
export default function RegistrationDlg({ idToken, onComplete }: Props) {
  ...
  if (isMobile && isPortrait) {
    return (
      <div style={{ position: 'fixed', inset: 0, zIndex: 1000, background: '#d4d0c8',
        ...
        fontFamily: 'var(--majak-font-family-ui)', gap: 16 }}>
        <div style={{ fontSize: 'var(--majak-font-48)' }}>↻</div>
        <div style={{ fontSize: 'var(--majak-font-16)', fontWeight: 700 }}>端末を横向きにしてください</div>
        <div style={{ fontSize: 'var(--majak-font-13)', color: '#555' }}>Please rotate your device</div>
      </div>
    )
  }
  ...
  const stepIndicator = (label: string, active: boolean, done: boolean) => (
    <span style={{
      padding: '2px 12px', borderRadius: 10, fontSize: isMobile ? 'var(--majak-font-11)' : 'var(--majak-font-13)',
    ...
    return (
      <div style={overlayStyle}>
        <div style={panelStyle}>
          ...
          <div style={{ flexShrink: 0, marginBottom: isMobile ? 8 : 12, fontSize: isMobile ? 'var(--majak-font-15)' : 'var(--majak-font-20)', fontWeight: 700 }}>利用規約</div>
          ...
          <div style={isMobile ? {
            ...
            fontSize: 'var(--majak-font-12)', lineHeight: 1.85, color: '#222',
          } : {
            flex: 1, minHeight: 0,
            overflowY: 'auto', padding: '14px 18px',
            background: '#fff', border: '1px inset #aaa',
            fontSize: 'var(--majak-font-14)', lineHeight: 1.95, color: '#222',
          }}>
            <b>麻雀4 利用規約</b><br /><br />
          ...
          <label style={{ flexShrink: 0, display: 'flex', alignItems: 'center', gap: 8, margin: `${isMobile ? 10 : 16}px 0 ${isMobile ? 6 : 8}px`, fontSize: isMobile ? 'var(--majak-font-12)' : 'var(--majak-font-14)' }}>
    ...
    return (
      <div style={overlayStyle}>
        <div style={widePanelStyle}>
          ...
          <div style={{ flexShrink: 0, marginBottom: isMobile ? 12 : 18, fontSize: isMobile ? 'var(--majak-font-15)' : 'var(--majak-font-20)', fontWeight: 700 }}>ニックネームの設定</div>

          <div style={{ flexShrink: 0, marginBottom: isMobile ? 6 : 10, fontSize: isMobile ? 'var(--majak-font-12)' : 'var(--majak-font-14)' }}>
          ...
          />
          <div style={{ flexShrink: 0, minHeight: 20, marginTop: 5, fontSize: isMobile ? 'var(--majak-font-11)' : 'var(--majak-font-13)',
      ...
      <div style={widePanelStyle}>
        ...
        {isMobile ? (
          <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 6 }}>
            <div style={{ fontSize: 'var(--majak-font-14)', fontWeight: 700 }}>プロフィール設定</div>
            <div style={{ display: 'flex', gap: 14, fontSize: 'var(--majak-font-12)' }}>
          ...
          <div style={{ flexShrink: 0, marginBottom: 14, fontSize: 'var(--majak-font-20)', fontWeight: 700 }}>プロフィール設定</div>
        )}
        ...
        {!isMobile && (
          <div style={{ flexShrink: 0, marginBottom: 14, fontSize: 'var(--majak-font-15)' }}>
