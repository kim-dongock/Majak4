...
export const UI_COLOR_THEMES = {
  jade: { label: '翡翠', screen: '#0b3b32', panel: '#f5f0e4', border: '#9b7a3c', title: '#164f43', command: '#3b8a71', commandHover: '#278064', commandBorder: '#145040', text: '#26352f', headerText: '#fff8e8', overlay: 'rgba(5, 24, 20, .72)' },
  vermilion: { label: '朱雀', screen: '#4a201c', panel: '#f9f1e8', border: '#a98042', title: '#7b3027', command: '#c45d4d', commandHover: '#c65a45', commandBorder: '#7d3026', text: '#382923', headerText: '#fff8e8', overlay: 'rgba(31, 9, 7, .74)' },
  indigo: { label: '藍', screen: '#182f47', panel: '#f1f3ed', border: '#83989c', title: '#254e69', command: '#4b8293', commandHover: '#3d8291', commandBorder: '#245565', text: '#24323a', headerText: '#f6faf4', overlay: 'rgba(7, 17, 30, .74)' },
  charcoal: { label: '墨', screen: '#282c2b', panel: '#f4f1e8', border: '#9b8c6c', title: '#3b4841', command: '#789080', commandHover: '#73907b', commandBorder: '#465b4d', text: '#29302c', headerText: '#fffaf0', overlay: 'rgba(10, 12, 11, .76)' },
  whiteTiger: { label: '白虎', screen: '#34454a', panel: '#f7f8f5', border: '#9aafb2', title: '#405d64', command: '#75969c', commandHover: '#6f9298', commandBorder: '#3f6269', text: '#29363a', headerText: '#f7fbfb', overlay: 'rgba(15, 24, 27, .72)' },
  gold: { label: '金', screen: '#4b3512', panel: '#fbf3dc', border: '#b88b32', title: '#735116', command: '#b48636', commandHover: '#bb8828', commandBorder: '#705016', text: '#3b2b13', headerText: '#fff9e9', overlay: 'rgba(31, 20, 4, .74)' },
  amethyst: { label: '紫苑', screen: '#362543', panel: '#f7f0f6', border: '#aa82a3', title: '#643f63', command: '#a4739e', commandHover: '#a36b9d', commandBorder: '#653f63', text: '#392b3c', headerText: '#fff8fc', overlay: 'rgba(23, 12, 29, .74)' },
  teal: { label: '青磁', screen: '#123f43', panel: '#eef7f3', border: '#78a89a', title: '#1b6261', command: '#4d9b91', commandHover: '#3b9d91', commandBorder: '#1a625d', text: '#213b3a', headerText: '#f2fffb', overlay: 'rgba(4, 27, 29, .74)' },
  sakura: { label: '桜', screen: '#4a2734', panel: '#fff3f6', border: '#d78ca4', title: '#8f4c65', command: '#d17b95', commandHover: '#d77a95', commandBorder: '#914055', text: '#422832', headerText: '#fff8fa', overlay: 'rgba(34, 12, 21, .74)' },
  lapis: { label: '瑠璃', screen: '#182748', panel: '#f0f4ff', border: '#849bd0', title: '#354f91', command: '#6b8bcd', commandHover: '#6689d4', commandBorder: '#304c8d', text: '#23304e', headerText: '#f5f8ff', overlay: 'rgba(7, 15, 35, .74)' },
