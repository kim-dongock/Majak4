...
export default function RoomCreateDlg({ initialTitle, viewerEnable = true, trainingMode = false, onOK, onCancel }: Props) {
  ...
  const btnStyle: React.CSSProperties = {
    position: 'absolute', fontFamily: FONT, fontSize: 'var(--majak-popup-font-emphasis)', color: '#111',
    background: '#f4f4f4',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontFamily: FONT, fontSize: 'var(--majak-popup-font-title)', color: '#111' }}>部屋を作る</span>
        </div>
        ...
        <div style={{ position: 'relative', width: dlgW, height: contentH, background: DLG_BG }}>
          ...
          <div ref={titleComboRef} style={{ position: 'absolute', left: px(8), top: py(18), width: px(132), height: py(14), zIndex: 5 }}>
            <input
              ...
              style={{
                ...
                fontFamily: FONT, fontSize: 'var(--majak-popup-font-emphasis)', boxSizing: 'border-box', padding: '0 2px',
            ...
            <button
              ...
              style={{
                ...
                fontFamily: FONT, fontSize: 'var(--majak-popup-font-body)', lineHeight: `${py(14) - 2}px`, color: '#111',
            ...
            {titleListOpen && (
              <div style={{
                ...
                fontFamily: FONT, fontSize: 'var(--majak-popup-font-body)', color: '#111', zIndex: 10,
              }}>
          ...
          <label style={{ position: 'absolute', left: px(9), top: py(54), display: 'flex', alignItems: 'center', gap: 4, fontFamily: FONT, fontSize: 'var(--majak-popup-font-body)', color: '#111', cursor: 'pointer' }}>
          ...
          <label style={{ position: 'absolute', left: px(9), top: py(67), display: 'flex', alignItems: 'center', gap: 4, fontFamily: FONT, fontSize: 'var(--majak-popup-font-body)', color: '#111', cursor: 'pointer' }}>
            <input type="radio" name="room-create-private" checked={isPrivate} onChange={() => setIsPrivate(true)} style={{ margin: 0, width: 13, height: 13 }} />
            カギ
          </label>
          <span style={{ position: 'absolute', left: px(53), top: 102, fontFamily: FONT, fontSize: 'var(--majak-popup-font-emphasis)', color: '#111' }}>パスワード</span>
          <input
            type="password"
            value={password}
            maxLength={PASSWORD_MAX}
          ...
          {viewerEnable && (
            <fieldset style={{ ...groupStyle, left: px(4), top: viewerTop, width: px(138), height: py(24) }}>
              ...
              <label style={{ position: 'absolute', left: px(8), top: 4, display: 'flex', alignItems: 'center', gap: 4, fontFamily: FONT, fontSize: 'var(--majak-popup-font-body)', color: '#111', cursor: 'pointer' }}>
              ...
              <label style={{ position: 'absolute', left: px(83), top: 4, display: 'flex', alignItems: 'center', gap: 4, fontFamily: FONT, fontSize: 'var(--majak-popup-font-body)', color: '#111', cursor: 'pointer' }}>
