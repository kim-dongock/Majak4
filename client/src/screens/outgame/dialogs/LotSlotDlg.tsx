  ...
  return (
    <div className="majak-popup-overlay majak-lottery-slot-overlay" role="presentation">
      ...
      <style>{`
        ...
        .majak-lottery-game-panel__close { border-color: #d9bc62; color: #f8f6e9; background: #1c6b58; cursor: pointer; }.majak-lottery-game-panel__close:hover, .majak-lottery-game-panel__close:focus-visible { background: #247c67; }.majak-lottery-game-panel__close:disabled { opacity: .45; }
