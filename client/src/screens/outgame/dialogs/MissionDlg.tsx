...
function ResponsiveMissionDialog({
  ...
  return <div className={`majak-popup-overlay mission-dialog-overlay${modeClass}`}>
    ...
    <style>{`
      ...
      .mission-dialog__summary strong { color: #1f4d42; font: 700 var(--majak-popup-font-emphasis)/var(--majak-popup-leading-emphasis) var(--majak-font-family-ui); text-align: right; }
      ...
      .mission-dialog__content h3 { margin: 0 0 10px; color: #31473f; font-size: var(--majak-popup-font-emphasis); font-weight: 700; line-height: var(--majak-popup-leading-emphasis); }
      .mission-dialog__daily h3 { font-size: var(--majak-popup-font-emphasis); }
      .mission-dialog__daily ol { display: grid; gap: 5px; margin: 0; padding: 0; list-style: none; }
      .mission-dialog__daily li { display: grid; grid-template-columns: 24px minmax(0, 1fr) auto; gap: 9px; align-items: center; min-height: 34px; padding: 7px 10px; border: 1px solid #d2dacf; background: #fffdf8; color: #52645d; font: var(--majak-popup-font-body)/var(--majak-popup-leading-body) var(--majak-font-family-ui); }
      .mission-dialog__daily li.is-complete { color: #1f4d42; border-color: #aebfab; background: #edf3e8; }
      .mission-dialog__check { display: grid; place-items: center; width: 20px; height: 20px; border: 1px solid #aeb8ae; color: #fff; background: #fff; font: 700 var(--majak-popup-font-body)/1 var(--majak-font-family-ui); }
      .mission-dialog__daily .is-complete .mission-dialog__check { border-color: #1c5a4d; background: #1c5a4d; }
      .mission-dialog__daily b { color: #a06425; font: 700 var(--majak-popup-font-body)/var(--majak-popup-leading-body) var(--majak-font-family-ui); white-space: nowrap; }
      .mission-dialog__weekly h3 { font-size: var(--majak-popup-font-emphasis); }
      ...
      .mission-dialog--mobileLandscape .mission-dialog__summary strong, .mission-dialog--mobilePortrait .mission-dialog__summary strong { font-size: var(--majak-popup-font-emphasis); }
      ...
      .mission-dialog--mobileLandscape .mission-dialog__content h3, .mission-dialog--mobilePortrait .mission-dialog__content h3 { margin-bottom: 6px; font-size: var(--majak-popup-font-emphasis); }
      .mission-dialog--mobileLandscape .mission-dialog__daily h3, .mission-dialog--mobilePortrait .mission-dialog__daily h3 { font-size: var(--majak-popup-font-emphasis); }
      .mission-dialog--mobileLandscape .mission-dialog__daily ol, .mission-dialog--mobilePortrait .mission-dialog__daily ol { gap: 3px; }
      .mission-dialog--mobileLandscape .mission-dialog__daily li, .mission-dialog--mobilePortrait .mission-dialog__daily li { grid-template-columns: 16px minmax(0, 1fr) auto; gap: 4px; min-height: 25px; padding: 4px; font-size: var(--majak-popup-font-body); }
      .mission-dialog--mobileLandscape .mission-dialog__check, .mission-dialog--mobilePortrait .mission-dialog__check { width: 14px; height: 14px; font-size: var(--majak-popup-font-body); }
      .mission-dialog--mobileLandscape .mission-dialog__daily b, .mission-dialog--mobilePortrait .mission-dialog__daily b { font-size: var(--majak-popup-font-body); }
      .mission-dialog--mobileLandscape .mission-dialog__weekly h3, .mission-dialog--mobilePortrait .mission-dialog__weekly h3 { font-size: var(--majak-popup-font-emphasis); }
    ...
    <div style={{
      ...
      >
        ...
        <div style={{
          ...
          fontSize: 'var(--majak-popup-font-emphasis)', fontWeight: 'bold', color: '#fff',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          pointerEvents: 'none',
        }}>
