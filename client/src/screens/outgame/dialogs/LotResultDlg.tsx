  ...
  return (
    <div className="majak-popup-overlay majak-lottery-result-overlay" role="presentation">
      <section className="majak-lottery-result-panel" role="dialog" aria-modal="true" aria-label={`${itemName} 抽選結果`}>
        ...
        <header className="majak-lottery-result-panel__header"><strong>{itemName} 抽選結果</strong><button className="majak-popup-titlebar__close" type="button" onClick={onClose} aria-label="閉じる">×</button></header>
