      ...
      <div style={{ position: 'relative', width: CHILD_W + 20, boxShadow: '3px 3px 8px rgba(0,0,0,0.6)' }}>
        ...
        <div style={{ background: DLG_BG, padding: '8px 10px', width: CHILD_W + 20, boxSizing: 'border-box' }}>
          ...
          <div style={{ marginBottom: 6 }}>
            <div style={{ fontFamily: FONT, fontSize: 'calc(12px * var(--majak-type-scale))', color: '#000', marginBottom: 2 }}>ファイル名</div>
            <input
              type="text"
              value={fileName}
              onChange={e => setFileName(e.target.value)}
              style={{
                width: '100%', fontFamily: FONT, fontSize: 'calc(12px * var(--majak-type-scale))', color: '#000',
