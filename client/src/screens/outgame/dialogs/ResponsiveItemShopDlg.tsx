...
export default function ResponsiveItemShopDlg({
  ...
  return (
    <>
      <div className={`majak-popup-overlay responsive-shop-overlay${mobileLayoutClass}`}>
        <section className={`majak-popup-panel responsive-shop${mobileLayoutClass}`} role="dialog" aria-modal="true" aria-label="麻雀ショップ">
          <header className="majak-popup-titlebar responsive-shop__header">
            <div>
              <h2>麻雀ショップ</h2>
            </div>
          ...
          <main className="majak-popup-body responsive-shop__content">
            {tab === 'cash' && (
          ...
          <footer className="majak-popup-actions responsive-shop__footer">
      ...
      <style>{`
        ...
        .responsive-shop { --shop-font-title: var(--majak-text-xl); --shop-font-price: var(--majak-text-lg); --shop-font-card-title: var(--majak-text-md); --shop-font-label: var(--majak-text-sm); --shop-font-body: var(--majak-text-sm); --shop-font-command: var(--majak-text-sm); width: min(1120px, 100%); height: min(620px, 100%); max-height: 100%; min-height: 0; display: flex; flex-direction: column; overflow: hidden; color: #172323; background: var(--majak-popup-panel-color); border: 1px solid #7d8e80; box-shadow: 0 24px 72px rgba(0, 0, 0, .42); font-family: var(--majak-font-family-ui); }
        ...
        .shop-card__tag { min-height: 18px; color: #9a6322; font: 700 var(--shop-font-label)/var(--majak-popup-leading-body) var(--majak-font-family-ui); }
        .shop-card h3 { margin: 5px 0; overflow: hidden; color: #1f302b; font: 700 var(--shop-font-card-title)/var(--majak-popup-leading-emphasis) var(--majak-font-family-ui); text-overflow: ellipsis; white-space: nowrap; }
        .shop-card p { min-height: 32px; margin: 0; overflow: hidden; color: #607069; font: var(--shop-font-body)/var(--majak-popup-leading-body) var(--majak-font-family-ui); }
        ...
        .responsive-shop--mobileLandscape .responsive-shop__balance, .responsive-shop--mobilePortrait .responsive-shop__balance { gap: 4px; padding: 5px 4px; font-size: var(--shop-font-label); }
        ...
        .responsive-shop--mobileLandscape .responsive-shop__balance strong, .responsive-shop--mobilePortrait .responsive-shop__balance strong { font-size: var(--shop-font-card-title); }
        ...
        .responsive-shop--mobileLandscape .shop-card h3, .responsive-shop--mobilePortrait .shop-card h3 { margin: 3px 0; font-size: var(--shop-font-card-title); }
        .responsive-shop--mobileLandscape .shop-card p, .responsive-shop--mobilePortrait .shop-card p { min-height: 28px; font-size: var(--shop-font-body); }
        ...
        .responsive-shop--mobileLandscape .shop-card button, .responsive-shop--mobilePortrait .shop-card button { width: min(var(--majak-popup-command-width), 100%); height: var(--majak-popup-command-height); padding: 0 9px; font-size: var(--shop-font-command); }
